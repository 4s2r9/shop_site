...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="sukiya_item09.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "37">ミニ　380円</option>
        <option value = "38">並盛　480円</option>
        <option value = "39">1.5盛　580円</option>
        <option value = "40">大盛　620円</option>
        <option value = "41">特盛　720円</option>
      </select><br>
