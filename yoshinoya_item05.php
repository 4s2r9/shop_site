...
<h2 class="title">吉野家メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="yoshinoya_item05.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "25">小盛　528円</option>
        <option value = "26">並盛　548円</option>
        <option value = "27">アタマの大盛　658円</option>
        <option value = "28">大盛　718円</option>
        <option value = "29">特盛　838円</option>
        <option value = "30">超特盛　928円</option>
      </select><br>
