...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="matsuya_item01.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "1">ミニ盛　330円</option>
        <option value = "2">並盛　380円</option>
        <option value = "3">あたま大盛　480円</option>
        <option value = "4">大盛　530円</option>
        <option value = "5">特盛　650円</option>
      </select><br>
