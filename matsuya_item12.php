...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    <img src="img/matsuya_items/item12.jpg" alt="ブラウンソースエッグハンバーグ定食">
    <h1>ブラウンソースエッグハンバーグ定食</h1>

    <form action="matsuya_item12.php" method = "POST">
      <select name="size" class="size_select">
        <option value = "23">　680円</option>
      </select><br>
