...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <h1>マンハッタンデラックスカレー</h1>

    <form action="sukiya_item07.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "27">ミニ　790円</option>
        <option value = "28">並盛　890円</option>
        <option value = "29">1.5盛　990円</option>
        <option value = "30">大盛　1030円</option>
        <option value = "31">特盛　1130円</option>
      </select><br>
