...
<h2 class="title">吉野家メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="yoshinoya_item01.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "1">小盛　332円</option>
        <option value = "2">並盛　352円</option>
        <option value = "3">アタマの大盛　462円</option>
        <option value = "4">大盛　522円</option>
        <option value = "5">特盛　642円</option>
        <option value = "6">超特盛　732円</option>
      </select><br>
