...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="sukiya_item01.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "1">ミニ　290円</option>
        <option value = "2">並盛　350円</option>
        <option value = "3">中盛　480円</option>
        <option value = "4">大盛　480円</option>
        <option value = "5">特盛　630円</option>
        <option value = "6">メガ　780円</option>
      </select><br>
