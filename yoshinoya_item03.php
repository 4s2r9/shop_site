...
<h2 class="title">吉野家メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="yoshinoya_item03.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "13">小盛　332円</option>
        <option value = "14">並盛　353円</option>
        <option value = "15">アタマの大盛　462円</option>
        <option value = "16">大盛　522円</option>
        <option value = "17">特盛　642円</option>
        <option value = "18">超特盛　732円</option>
      </select><br>
