...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="sukiya_item02.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "7">ミニ　420円</option>
        <option value = "8">並盛　480円</option>
        <option value = "9">中盛　610円</option>
        <option value = "10">大盛　610円</option>
        <option value = "11">特盛　760円</option>
        <option value = "12">メガ　910円</option>
      </select><br>
