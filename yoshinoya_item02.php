...
<h2 class="title">吉野家メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="yoshinoya_item02.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "7">小盛　440円</option>
        <option value = "8">並盛　460円</option>
        <option value = "9">アタマの大盛　570円</option>
        <option value = "10">大盛　630円</option>
        <option value = "11">特盛　750円</option>
        <option value = "12">超特盛　840円</option>
      </select><br>
