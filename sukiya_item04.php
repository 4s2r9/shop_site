...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="sukiya_item04.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "19">ミニ　440円</option>
        <option value = "20">並盛　500円</option>
        <option value = "21">中盛　630円</option>
        <option value = "22">大盛　630円</option>
        <option value = "23">特盛　780円</option>
        <option value = "24">メガ　930円</option>
      </select><br>
