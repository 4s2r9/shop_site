...
<h2 class="title">松屋メニュー</h2>
  ...
  <section class="item">
    ...
    <form action="sukiya_item08.php" method = "POST">
      <select name="size" class="size_select">
        <option value="">サイズを選択してください</option>
        <option value = "32">ミニ　670円</option>
        <option value = "33">並盛　770円</option>
        <option value = "34">1.5盛　870円</option>
        <option value = "35">大盛　910円</option>
        <option value = "36">特盛　1010円</option>
      </select><br>
